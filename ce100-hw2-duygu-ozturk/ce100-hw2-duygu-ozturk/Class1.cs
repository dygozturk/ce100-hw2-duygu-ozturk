...
namespace ce100_hw2_duygu_ozturk
{
    public class Class1
        ...
        *
        *	  Matrix multiplication is a binary operation. A matrix consists of two or more matrices. 
        *	  But for matrix multiplication, the number columns of the first matrix are 2. it must be equal to the row columns of the matrix.
        *
        ...
        *
        *	  Given two square matrices A and B of size nxn for each of them in this matrix, find the multiplication matrices.
        *
        ...
        *
        *	  Two pointers, starting from both ends of the sequence being divided, 
        *	  then move towards each other until they detect an inversion. a pair of elements, one greater than the bound:
        *	  the first pointer is larger than the boundary, the second pointer is a pair smaller than the boundary; if at this point the first pointer is still before the second, 
        *	  then this pair is in the wrong order relative to each other, and then they are exchanged.
        *
        ...
        *
        *   In the Quicksort function, we first divide the array into sections such that all elements to the left of the pivot element are smaller, 
        *   and all elements to the right of the pivot are larger than the pivot.
        *
        ...
        *
        *   In the Ouicksort function, we first divide the array into sections such that all elements to the left of the pivot element are smaller, 
        *   and all elements to the right of the pivot are larger than the pivot.
        *
        ...
        *
        *	@param  [in] mass [\i int]   SELECTION PROBLEM in the serie
        *
        *   @retval [\i int]  SELECTION PROBLEM
        **/
        ...
        *
        *   Heap Sort function is a comparison-based sorting technique based on binary heap data structure. 
        *   It is similar to the selection sequence,where we first find the minimum element and place the minimum element at the beginning of the moment.
        *
        ...
        *
        *   1. each element has a priority associated with it.
        *   2. An element with a high priority is dequeued before an element with a low priority.
        *   3. If two elements have the same priority, they are presented in their turn next to each other.
        *
        ...
        *
        *   Counting Sort  is an algorithm that sorts the elements of an array by counting the number of occurrences of each unique element in the array. ,
        *   The count is stored in an auxiliary array and sorted, its counting is done by mapping it as an index of the auxiliary array.
        *
        ...
        *
        *   Sorting by numbers is an algorithm in computer science that sorts numbers over their digits.
        *
